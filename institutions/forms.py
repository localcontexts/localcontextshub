...
class CreateInstitutionForm(forms.ModelForm):
    ror_id = forms.CharField(widget=forms.HiddenInput(attrs={
        'id': 'institutionIDROR',
        'value': ''
    }))
    ...
    class Meta:
        model = Institution
        fields = [
            'institution_name', 'ror_id', 'city_town', 'state_province_region',
            'country', 'description'
        ]
        error_messages = {
            'institution_name': {
        ...
        widgets = {
            ...
            forms.TextInput(
                attrs={
                    ...
                    'autocomplete': 'off',
                    'required': True,
                    'placeholder': 'Search ROR institutions...'
                }),
            'ror_id':
            ...
            forms.TextInput(attrs={
                'id': 'institutionCityTown',
                'class': 'w-100'
            }),
            'state_province_region':
            forms.TextInput(attrs={
                'id': 'institutionStateProvRegion',
                'class': 'w-100'
            }),
            'description':
...
class CreateInstitutionNoRorForm(forms.ModelForm):
    ...
    class Meta:
        model = Institution
        fields = [
            'institution_name', 'city_town', 'state_province_region',
            'country', 'description', 'is_ror'
        ]
        error_messages = {
            'institution_name': {
                'unique': _("An institution by that name already exists."),
    ...
    class Meta:
        ...
        widgets = {
            ...
            forms.EmailInput(attrs={
                'class': 'w-100',
                'id': 'institutionContactEmailField'
            }),
            'support_document':
            forms.ClearableFileInput(
                attrs={
                    'class': 'w-100 hide',
                    'id': 'institutionSupportLetterUploadBtn',
...
class UpdateInstitutionForm(forms.ModelForm):
    ...
    class Meta:
        model = Institution
        fields = [
            'city_town', 'state_province_region', 'country', 'image',
            'description'
        ]
        widgets = {
            'state_province_region':
