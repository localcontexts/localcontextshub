...
class Institution(models.Model):
    institution_creator = models.ForeignKey(User,
    ...
    image = models.ImageField(upload_to=institution_img_path,
                              blank=True,
                              null=True)
    ...
    admins = models.ManyToManyField(User,
                                    blank=True,
                                    related_name="institution_admins")
    editors = models.ManyToManyField(User,
                                     blank=True,
                                     related_name="institution_editors")
    viewers = models.ManyToManyField(User,
                                     blank=True,
                                     related_name="institution_viewers")
    is_approved = models.BooleanField(default=False, null=True)
    approved_by = models.ForeignKey(User,
                                    null=True,
                                    blank=True,
                                    on_delete=models.SET_NULL,
                                    related_name="institution_approver")
    ...
    def is_user_in_institution(self, user):
        ...
        ) or user in self.admins.all() or user == self.institution_creator:
            return True
        else:
            return False

    def get_distinct_creators(self):
        project_creators = self.institution_created_project.filter(
            institution=self).distinct("project__project_creator")
        return [
            element.project.project_creator for element in project_creators
        ]
    ...
    def institution_projects(self):
        institution_projects = self.institution_created_project.filter(
            institution=self)
