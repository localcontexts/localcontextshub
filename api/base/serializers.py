...
class BCLabelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = BCLabel
        fields = (
        'unique_id', 'name', 'label_type', 'language_tag', 'language', 'label_text', 'img_url', 'svg_url', 'audiofile',
...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Project
        fields = (
        'unique_id', 'providers_id', 'source_project_uuid', 'project_page', 'title', 'project_privacy', 'date_added',
        'date_modified', 'created_by', 'notice', 'sub_projects', 'related_projects', 'project_boundary_geojson')
...
class ProjectNoNoticeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
        'unique_id', 'providers_id', 'source_project_uuid', 'project_page', 'title', 'project_privacy', 'date_added',
        'date_modified', 'created_by', 'bc_labels', 'tk_labels', 'sub_projects', 'related_projects',
