...
def registry(request, filtertype=None):
    ...
    try:
        ...
        i = Institution.approved.select_related('institution_creator').prefetch_related(
            'admins', 'editors', 'viewers'
...
def projects_board(request, filtertype=None):
    try:
        approved_institutions = Institution.objects.filter(is_approved=True
