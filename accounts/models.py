...
class Profile(models.Model):
    ...
    profile_pic = models.ImageField(upload_to='photos/',
                                    ...
                                    null=True,
                                    default='default.png')
    city_town = models.CharField(verbose_name='city or town',
                                 max_length=80,
                                 blank=True,
                                 null=True)
    ...
    position = models.CharField(verbose_name='position',
                                ...
                                blank=True,
                                null=True)
    affiliation = models.CharField(verbose_name='affiliation',
                                   max_length=250,
                                   blank=True,
                                   null=True)
    preferred_language = models.CharField(verbose_name='preferred language',
                                          max_length=80,
                                          blank=True,
                                          null=True)
    api_key = models.CharField(max_length=80, blank=True, null=True)
    languages_spoken = models.CharField(verbose_name='languages spoken',
                                        max_length=150,
                                        blank=True,
                                        null=True)
...
class Subscription(models.Model):
    ...
    users_count = models.IntegerField(help_text="For unlimited counts the value shoud be -1")
    api_key_count = models.IntegerField(help_text="For unlimited counts the value shoud be -1")
    project_count = models.IntegerField(help_text="For unlimited counts the value shoud be -1")
    notification_count = models.IntegerField(help_text="For unlimited counts the value shoud be -1")
