...
urlpatterns = [
    path('connect-researcher/',
         views.connect_researcher,
    ...
    path('projects/create-project/<str:pk>/',
         views.create_project,
         name="researcher-create-project"),
    path('projects/edit-project/<str:researcher_id>/<uuid:project_uuid>/',
         views.edit_project,
    ...
    path('projects/delete-project/<str:researcher_id>/<uuid:project_uuid>/',
         views.delete_project,
         name="researcher-delete-project"),
    path('projects/archive-project/<str:researcher_id>/<uuid:project_uuid>',
