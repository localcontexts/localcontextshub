...
class UpdateResearcherForm(forms.ModelForm):
    ...
    contact_email_public = forms.ChoiceField(
        label=_('Can this email be used for users of the Local Contexts Hub to contact you?'),
        choices=PRIVACY,
        initial='False',
        widget=forms.RadioSelect(attrs={'class': 'ul-no-bullets'})
        )
