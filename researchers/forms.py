...
class UpdateResearcherForm(forms.ModelForm):
    ...
    contact_email_public = forms.ChoiceField(label=_(
        'Can this email be used for users of the Local Contexts Hub to contact you?'
    ),
                                             choices=PRIVACY,
                                             initial='False',
    ...
    class Meta:
        model = Researcher
        fields = [
            'primary_institution', 'contact_email', 'contact_email_public',
