...
class NoticeFactory(factory.django.DjangoModelFactory):
    ...
    notice_type = factory.Faker('random_element', elements=['biocultural', 'traditional_knowledge', 'attribution_incomplete'])
...
class ProjectStatusFactory(factory.django.DjangoModelFactory):
    ...
    status = factory.Faker('random_element', elements=['pending', 'not_pending', 'labels_applied'])
...
class CollectionsCareNoticePolicyFactory(factory.django.DjangoModelFactory):
    ...
    institution = factory.SubFactory(InstitutionFactory)
    policy_document = SimpleUploadedFile("policy_document.txt", b"file_content", content_type="text/plain")
    url = factory.Faker('url')
    added = factory.Faker('date_time_this_year')
...
class HubActivityFactory(factory.django.DjangoModelFactory):
    ...
    action_type = factory.Faker('random_element', elements=('New Member Added', 'New User', 'New Researcher', 'New Community', 'New Institution', 'Project Edited', 'Project Created', 'Community Notified', 'Label(s) Applied', 'Disclosure Notice(s) Added', 'Engagement Notice Added'))
