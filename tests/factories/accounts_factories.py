...
class ProfileFactory(factory.django.DjangoModelFactory):
    ...
    api_key = factory.Faker('sha256(raw_output=False)')
    languages_spoken = fake.language_name()
    is_researcher = factory.Faker('boolean(chance_of_getting_true=50)')
    onboarding_on = factory.Faker('boolean(chance_of_getting_true=50)')