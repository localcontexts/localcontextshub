...
class Notice(models.Model):
    ...
    def set_translation(self, language_tag):
        with open('./localcontexts/static/json/NoticeTranslations.json',
                  encoding="utf8") as json_file:
            translations_data = json.load(json_file)

        translation = None
        for item in translations_data:
            if item['noticeType'] == self.notice_type and item[
    ...
    class Meta:
        indexes = [
            models.Index(fields=['project', 'researcher', 'institution'])
        ]
        verbose_name = 'Notice'
...
class NoticeTranslation(models.Model):
    ...
    notice = models.ForeignKey(Notice,
                               on_delete=models.CASCADE,
                               related_name="notice_translations")
...
class OpenToCollaborateNoticeURL(models.Model):
    institution = models.ForeignKey(Institution,
                                    ...
                                    blank=True,
                                    db_index=True,
                                    related_name="otc_institution_url")
    researcher = models.ForeignKey(Researcher,
                                   null=True,
                                   on_delete=models.CASCADE,
                                   blank=True,
                                   db_index=True,
                                   related_name="otc_researcher_url")
    name = models.CharField('Name of Website',
                            max_length=250,
                            null=True,
                            blank=True)
...
class EntitiesNotified(models.Model):
    project = models.ForeignKey('projects.Project',
                                null=True,
                                on_delete=models.CASCADE,
                                related_name="project_notified",
                                db_index=True)
    communities = models.ManyToManyField(Community,
                                         blank=True,
                                         related_name="communities_notified",
                                         db_index=True)
    institutions = models.ManyToManyField(Institution,
                                          blank=True,
                                          related_name="institutions_notified",
                                          db_index=True)
    researchers = models.ManyToManyField(Researcher,
                                         blank=True,
                                         related_name="researchers_notified",
                                         db_index=True)
...
class LabelTranslation(models.Model):
    bclabel = models.ForeignKey(BCLabel,
                                null=True,
                                blank=True,
                                on_delete=models.CASCADE,
                                related_name="bclabel_translation")
    tklabel = models.ForeignKey(TKLabel,
                                null=True,
                                blank=True,
                                on_delete=models.CASCADE,
                                related_name="tklabel_translation")
    translated_name = models.CharField(max_length=150, blank=True)
    language_tag = models.CharField(max_length=5, blank=True)
    language = models.CharField(max_length=150, blank=True)
    translated_text = models.TextField(blank=True)
...
class ProjectComment(models.Model):
    ...
    message = models.TextField(max_length=1500, null=True,
                               blank=True)  #250 word limit on message
    created = models.DateTimeField(auto_now_add=True, null=True)
...
class LabelNote(models.Model):
    bclabel = models.ForeignKey(BCLabel,
                                ...
                                blank=True,
                                on_delete=models.CASCADE,
                                related_name="bclabel_note")
    tklabel = models.ForeignKey(TKLabel,
                                null=True,
                                blank=True,
                                on_delete=models.CASCADE,
                                related_name="tklabel_note")
    sender = models.ForeignKey(User,
                               on_delete=models.CASCADE,
                               null=True,
                               related_name="note_sender",
                               blank=True)
...
class LabelVersion(models.Model):
    created_by = models.ForeignKey(User,
                                   on_delete=models.CASCADE,
                                   null=True,
                                   related_name="version_creator",
                                   blank=True)
    is_approved = models.BooleanField(default=False, null=True)
    approved_by = models.ForeignKey(User,
                                    on_delete=models.CASCADE,
                                    null=True,
                                    related_name="version_approver",
                                    blank=True)
    bclabel = models.ForeignKey(BCLabel,
                                null=True,
                                blank=True,
                                on_delete=models.CASCADE,
                                related_name="bclabel_version")
    tklabel = models.ForeignKey(TKLabel,
                                null=True,
                                blank=True,
                                on_delete=models.CASCADE,
                                related_name="tklabel_version")
...
class LabelTranslationVersion(models.Model):
    version_instance = models.ForeignKey(
        LabelVersion,
        null=True,
        blank=True,
        on_delete=models.CASCADE,
        related_name="label_version_translation")
    translated_name = models.CharField(max_length=150, blank=True)
    language_tag = models.CharField(max_length=5, blank=True)
    language = models.CharField(max_length=150, blank=True)
    translated_text = models.TextField(blank=True)
...
class CollectionsCareNoticePolicy(models.Model):
    ...
    policy_document = models.FileField(
        upload_to='institutions/support-files/collections-care-policies',
        blank=True,
        null=True)
...
class HubActivity(models.Model):
    ...
    action_account_type = models.CharField(max_length=250,
                                           null=True,
                                           blank=True)
