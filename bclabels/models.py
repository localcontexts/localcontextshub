...
class BCLabel(models.Model):
    ...
    created_by = models.ForeignKey(User,
                                   ...
                                   related_name="bclabel_creator")
    label_type = models.CharField(max_length=20, null=True, choices=TYPES)
    community = models.ForeignKey(Community,
                                  null=True,
                                  on_delete=models.CASCADE,
                                  related_name='bclabel_community')
    name = models.CharField(verbose_name='label name',
                            max_length=90,
                            null=True,
                            blank=True)
    ...
    approved_by = models.ForeignKey(User,
                                    ...
                                    blank=True,
                                    on_delete=models.SET_NULL,
                                    related_name="bclabel_approver")
    last_edited_by = models.ForeignKey(User,
                                       null=True,
                                       blank=True,
                                       on_delete=models.SET_NULL,
                                       related_name="bclabel_last_edited_by")
    ...
    class Meta:
        indexes = [
            models.Index(fields=[
                'unique_id', 'created_by', 'community', 'is_approved',
                'approved_by', 'audiofile'
            ])
        ]
